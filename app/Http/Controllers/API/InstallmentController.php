...
class InstallmentController extends Controller {
 ...
 private function scopeBranch($q){if(!$this->canAccessAllBranches())$q->whereHas('booking.property.project', function ($x) { $x->where('branch_id', auth()->user()->branch_id); });return $q;}
