...
class PaymentController extends Controller
{
    ...
    {
        $q = Payment::with(['customer','booking.property','installment','receivedBy:id,name','reversedBy:id,name']);
    ...
    public function show(Payment $payment) { return response()->json($payment->load(['customer','booking.property.project','booking.property.block','installment','receivedBy','reversedBy'])); }
    ...
    public function reverse(Request $r, Payment $payment)
    {
        ...
        DB::transaction(function () use ($payment, $data, $r) {
        ...
        return response()->json(['message'=>'Payment reversed successfully.','payment'=>$payment->fresh()->load(['customer','booking.property','installment','receivedBy','reversedBy'])]);
    }
