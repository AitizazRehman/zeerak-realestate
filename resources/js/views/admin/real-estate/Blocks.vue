...
export default{
 ...
 methods:{
  blank(){return{project_id:this.filters.project_id||null,name:'',code:'',description:'',total_area:null,area_unit:'Marla',total_units:0,is_active:true}},
  ...
  openCreate(){if(!this.$can('projects.create'))return;this.editing=false;this.selectedId=null;this.form=this.blank();this.dialog=true},
