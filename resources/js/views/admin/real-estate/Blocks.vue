      ...
      <div class="d-flex align-center mb-5">
        <div>
          ...
          <div class="text-caption grey--text">
            Manage blocks and units within projects
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async loadBlocks() {
      ...
      try {
        const response = await api.get('/project-blocks', {
          params: {
    ...
    editBlock(block) {
      ...
      this.form = {
        ...
        area_unit: block.area_unit || 'Marla',
        total_units: block.total_units || 0,
    ...
    async saveBlock() {
      ...
      try {
        ...
        if (this.editing) {
          await api.put(
            `/project-blocks/${this.selectedId}`,
            this.form
          )
        } else {
          await api.post(
