...
<div class="page">
  ...
  <v-card outlined class="mt-5">
    ...
    <div class="pa-3 d-flex flex-wrap align-center">
      <span class="caption grey--text mr-3">Export current report:</span>
