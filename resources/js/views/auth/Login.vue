...
<v-container fluid class="login-page pa-0">
  <v-row no-gutters class="fill-height">
    <v-col cols="12" md="7" class="brand-panel d-none d-md-flex align-center justify-center">
      <div class="brand-content px-10">
        <div class="brand-logo mb-8"><img src="/images/zeerak-logo.jpeg" alt="ZeeraK logo"></div>
...
<style scoped>
.login-page{min-height:100vh;background:#f6f8f7}.fill-height{min-height:100vh}.brand-panel{position:relative;min-height:100vh;padding:64px;background:linear-gradient(145deg,#0b4329 0%,#165134 58%,#1d6242 100%)}.brand-content{width:100%;max-width:720px}.brand-logo{width:132px;height:132px;background:#fff;border-radius:20px;padding:10px;display:flex;align-items:center;justify-content:center;box-shadow:0 14px 35px rgba(0,0,0,.18);overflow:hidden}.brand-logo img{display:block;width:100%;height:100%;object-fit:contain}.gold--text{color:#d6b45d!important}.muted{opacity:.82;max-width:650px;line-height:1.8}.feature-row{display:flex;gap:28px;flex-wrap:wrap;color:#fff}.feature-row span{display:flex;gap:7px;align-items:center}.form-panel{min-height:100vh;background:#fff;padding:48px}.login-card{width:100%;max-width:480px;background:#fff!important}.login-btn{min-height:52px!important;background:#165134!important;border-color:#165134!important;color:#fff!important;font-weight:700;letter-spacing:.04em}.rounded-lg{border-radius:12px!important}@media(max-width:600px){.form-panel{padding:20px}.login-card{padding:24px!important}} .v-btn.login-btn.v-btn--disabled{background:#d8dedb!important;border-color:#d8dedb!important;color:#7c8781!important}
</style>