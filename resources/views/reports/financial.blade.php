...
<div style="margin-bottom:10px"><img src="{{ public_path('images/zeerak-logo.jpeg') }}" style="height:70px"><div style="font-weight:bold;color:#165134">ZeeraK Real Estate & Builders</div></div><h1>{{ $title }}</h1><div class="period">Period: {{ $from }} to {{ $to }}</div>
@if($rows->count())
